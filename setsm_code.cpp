...
const char setsm_version[] = "4.3.15";
        ...
        if(OpenProject(_filename,proinfo,args))
        {
            if(Maketmpfolders(proinfo))
            {
                ...
                *return_param = param;
                ...
                double Boundary[4], LBoundary[4],LminmaxHeight[2],ori_minmaxHeight[2];
...
{
    FILE *outfile_h, *outMean_ortho; //*outfile_min, *outfile_max, *outfile_flag, *outMean_ortho_asc
    CSize temp_S;
    char t_str[500];
    int k,j;
    /*FILE **outfile_roh;
