...
if(NOT TIFF_LIBRARY)
  find_library(TIFF_LIBRARY_RELEASE NAMES ${TIFF_NAMES} HINTS ENV LD_LIBRARY_PATH)
  find_library(TIFF_LIBRARY_DEBUG NAMES ${TIFF_NAMES_DEBUG} LD_LIBRARY_PATH)
...
find_path(TIFF_INCLUDE_DIR tiff.h HINTS "${TIFF_LIBRARY_PATH}/include")
